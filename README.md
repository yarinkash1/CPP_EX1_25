...
מחלקה זו תממש אלגוריתמים שונים על גרף מכוון ותכיל את:
...
3. פונקציה dijkstra – מקבלת גרף וקודקוד התחלה ומחזירה עץ של מסלולים קצרים ביותר ובנוסף תעדכן מערך קודקודים (או מבנה נתונים לבחירתכם) שיכיל את אורך המסלול הקצר ביותר בין קודקוד התחלה לבין כל אחד מהקודקודים.
